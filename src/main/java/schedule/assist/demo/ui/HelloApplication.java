...
public class HelloApplication extends Application {
    ...
    private static final double ADD_BUTTON_X = 1370;
    private static final double ADD_BUTTON_Y_OFFSET = 550;
    ...
    public void start(Stage stage) {
        ...
        buttonAddTask.setLayoutX(ADD_BUTTON_X);
        buttonAddTask.setLayoutY(SCREEN_H - ADD_BUTTON_Y_OFFSET);
